    ...
    return (
        <div>
            <div className={`fixed left-0 top-0 w-44 h-full bg-customYellow transition-all duration-500 ease-in-out ${isVisible ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <button className={`bg-black mt-[60px] w-[8.4rem] h-[32px]  ml-[19px] -mr-30 rounded-xl flex items-center justify-center transition-all duration-500 ease-in-out ${isVisible ? 'w-full' : 'w-0'}`}>
