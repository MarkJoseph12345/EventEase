                ...
                <div className="flex flex-col items-center w-full h-full bg-customYellow rounded-2xl box-border justify-between	py-10">
                    ...
                    <div className="flex justify-between gap-10">
                        <div>
                            ...
                            <input type="text" className="w-full h-[50px] rounded-2xl border-4 border-black" />
                        </div>
                        <div>
                    ...
                    <div className="w-[60%]">
                        ...
                        <select className="w-full h-[50px] rounded-2xl border-4 border-black">
                    ...
                    <div className="flex flex-col items-center">
                        <button className="bg-black text-customYellow w-[200px] h-[50px] text-2xl rounded font-bold">SIGN UP</button>
                        <p>Don't have an account? <Link href="/login" replace className="font-bold cursor-pointer">LOGIN</Link></p>
                    </div>
                </div>
            </div>
        </div>
